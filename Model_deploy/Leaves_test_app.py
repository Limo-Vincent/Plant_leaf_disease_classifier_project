...
if uploaded_file is None:
    ...
    with col1:
        st.image("Model_deploy/Images/image (612).JPG", caption="Corn (Common Rust)", width = 200)
    with col2:
        st.image("Model_deploy/Images/image (58).JPG", caption="Potato (Early Blight)", width = 200)
    with col3:
        st.image("Model_deploy/Images/image (156).JPG", caption="Tomato (Late Blight)", width = 200)
